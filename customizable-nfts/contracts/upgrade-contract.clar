...
;; Queue for work
(define-data-var disassemble-work-queue (list 250 {member: principal, token-id: uint}) (list))
      ...
      (let 
        ...
        (var-set disassemble-work-queue
          (begin
            ...
            (append 
              (unwrap-panic (as-max-len? work-queue-value u249)) 
              value-to-add
            )
          )
        )
...
(define-data-var assemble-work-queue (list 250 {member: principal, background-id: uint, car-id: uint, rim-id: uint, head-id: uint}) (list))
...
(define-data-var swap-work-queue (list 250 {member: principal, degen-id: uint, component-id: uint, component-type: (string-ascii 30)}) (list))
...
(define-data-var merge-work-queue (list 250 {member: principal, degen-id: uint, degen-type: (string-ascii 30)}) (list))
