...
const prefix = './';
const pathHeadsGen = './generated/images/';
const alienFace = './AlienFace/';
const alienHead = './AlienHead/';
const skullFace = './SkullFace/';
const skullHead = './SkullHead/';
const pathHeadsMapSC = './generated/headsMap.txt';

// empty map SC before appending to it
