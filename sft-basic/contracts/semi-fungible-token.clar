...
(define-private (is-owned-needed (item-id uint) (resource-id uint) (resource-qty uint)) 
  (and (> (get-balance-uint item-id tx-sender) u0) (>= (get-balance-uint resource-id tx-sender) resource-qty))
)

(define-public (level-up (id-new uint))
  (begin 
    (asserts! (is-owned-needed 
      (unwrap-panic (unwrap-panic (get-upgrade-item-id id-new))) 
      (unwrap-panic (unwrap-panic (get-upgrade-resources-id id-new))) 
      (unwrap-panic (unwrap-panic (get-upgrade-resources-qty id-new)))) 
      err-insufficient-balance)
    (some (transfer (unwrap-panic (unwrap-panic (get-upgrade-item-id id-new))) u1 tx-sender 'ST2CY5V39NHDPWSXMW9QDT3HC3GD6Q6XX4CFRK9AG))  
    (some (transfer (unwrap-panic (unwrap-panic (get-upgrade-resources-id id-new))) (unwrap-panic (unwrap-panic (get-upgrade-resources-qty id-new))) tx-sender 'ST2CY5V39NHDPWSXMW9QDT3HC3GD6Q6XX4CFRK9AG))  
...
(define-map token-name { id: uint } { name: (string-ascii 256), type: (string-ascii 256), values: {dmg: uint} })
...
(map-set token-name {id: u1} {name: "gold", type: "resource", values: {dmg: u0}})
(map-set token-name {id: u2} {name: "diamond", type: "resource", values: {dmg: u0}})
(map-set token-name {id: u5} {name: "sword_1_1", type: "sword", values: {dmg: u1}})
(map-set token-name {id: u6} {name: "sword_1_2", type: "sword", values: {dmg: u2}})
(map-set token-name {id: u7} {name: "sword_1_3", type: "sword", values: {dmg: u3}})
(map-set token-name {id: u8} {name: "sword_2_1", type: "sword", values: {dmg: u2}})
(map-set token-name {id: u9} {name: "sword_2_2", type: "sword", values: {dmg: u3}})
(map-set token-name {id: u10} {name: "sword_2_3", type: "sword", values: {dmg: u4}})
(map-set token-name {id: u11} {name: "sword_3_1", type: "sword", values: {dmg: u3}})
(map-set token-name {id: u12} {name: "sword_3_2", type: "sword", values: {dmg: u4}})
(map-set token-name {id: u13} {name: "sword_3_3", type: "sword", values: {dmg: u5}})
(map-set token-name {id: u14} {name: "armor_1_1", type: "armor", values: {dmg: u3}})
(map-set token-name {id: u15} {name: "armor_1_2", type: "armor", values: {dmg: u4}})
(map-set token-name {id: u16} {name: "armor_1_3", type: "armor", values: {dmg: u5}})
