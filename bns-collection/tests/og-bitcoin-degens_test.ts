...
// const BNS_NFT_CONTRACT_NAME = 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.og-bitcoin-degens';
...
// const URI_ROOT = 'ipfs://QmQcZyB1GEsZgYQXr82CHN2BeqEY53bmMPB89g6ryKPWJU/$TOKEN_ID.json';
...
// Clarinet.test({
//   name: 'Ensure that pay, integral and discounted, work as expected when whitelisted enable',
//   // whitelisted - can mint - 2, 3, 4, 5,
//   // have bns - discount - 2, 3, 6
//   // try mint with
//   //   2, 3 - discounted
//   //   4, 5 - full
//   //   6 - failed
...
//     //   6 - failed
//     block = chain.mineBlock([
//       Tx.contractCall(BNS_NFT_CONTRACT_NAME, FNC_CLAIM, [], bob.address), // discounted
//       Tx.contractCall(BNS_NFT_CONTRACT_NAME, FNC_CLAIM, [], bob.address), // discounted
//       Tx.contractCall(BNS_NFT_CONTRACT_NAME, FNC_CLAIM, [], bob.address), // discounted
//       Tx.contractCall(BNS_NFT_CONTRACT_NAME, FNC_CLAIM, [], charlie.address), // discounted
...
//     assertEquals(block.receipts[0].events[0].stx_transfer_event.amount, MINT_PRICE_DISCOUNTED);
...
//     assertEquals(block.receipts[1].events[0].stx_transfer_event.amount, MINT_PRICE_DISCOUNTED);
...
//     assertEquals(block.receipts[2].events[0].stx_transfer_event.amount, MINT_PRICE_DISCOUNTED);
...
//     assertEquals(block.receipts[3].events[0].stx_transfer_event.amount, MINT_PRICE_DISCOUNTED);
...
// Clarinet.test({
//   name: 'Ensure that pay, integral and discounted, and name-nft work as expected when whitelisted disabled',
//   //   2, 3 - discounted
//   //   4, 5 - full
//   async fn(chain: Chain, accounts: Map<string, Account>) {
//     const deployer = accounts.get('deployer')!;
...
//     assertEquals(block.receipts[4].events[0].stx_transfer_event.amount, MINT_PRICE_DISCOUNTED);
